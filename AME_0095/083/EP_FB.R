...
for(RI in 1:length(Tp)){
  ...
  write.csv(x=dat_2,file = paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_count.csv"))
  write.csv(x=tab,file = paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_tab.csv"))
  write.csv(x=Y,file = paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_tab_2.csv"))
}
...
for(RI in 1:length(Tp)){
  X <- read.csv(paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_tab_2.csv"),header = TRUE)
  DEGs <- X$X
  ...
  write.csv(x=X,file = paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_GO.csv"))
}

GOterm <- read.csv("C:/Users/monom/Documents/Tb_Goterm_list.csv",header = TRUE)
for(RI in 1:length(Tp)){
  XX <- read.csv(paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_GO.csv"),header = TRUE)
  ...
  XX <- XX[order(XX$FDR),]
  write.csv(x=XX,file = paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_GOterm.csv"))
}

for(RI in 1:length(Tp)){
  XX <- read.csv(paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_GOterm.csv"),header = TRUE)
  ...
  write.csv(x=XX,file = paste0("C:/Users/monom/Documents/DE/",Tp[RI],"_symbol.csv"))
}
